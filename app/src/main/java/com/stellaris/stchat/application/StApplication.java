package com.stellaris.stchat.application;
...
import com.stellaris.stchat.entity.NotificationClickEventReceiver;
//import com.stellaris.stchat.location.service.LocationService;
...
import com.stellaris.stchat.utils.imagepicker.GlideImageLoader;
import com.stellaris.stchat.utils.imagepicker.ImagePicker;
import com.stellaris.stchat.utils.imagepicker.view.CropImageView;

public class StApplication extends com.activeandroid.app.Application{
    ...
    public static String PICTURE_DIR = "sdcard/StChatDemo/pictures/";
    private static final String JCHAT_CONFIGS = "JChat_configs";
    public static String FILE_DIR = "sdcard/StChatDemo/recvFiles/";
    public static String VIDEO_DIR = "sdcarVIDEOd/StChatDemo/sendFiles/";
    ...
    public void onCreate() {
        ...
        THUMP_PICTURE_DIR = context.getFilesDir().getAbsolutePath() + "/StChatDemo";
    ...
    public static void setPicturePath(String appKey) {
        if (!SharePreferenceManager.getCachedAppKey().equals(appKey)) {
            ...
            PICTURE_DIR = "sdcard/StChatDemo/pictures/" + appKey + "/";
        }
    }
