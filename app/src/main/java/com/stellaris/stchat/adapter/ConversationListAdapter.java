...
import com.stellaris.stchat.view.SwipeLayoutConv;
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        if (TextUtils.isEmpty(draft)) {
            ...
            if (lastMsg != null) {
                ...
                if (mAtAll.get(position) && StApplication.isAtall.get(gid) != null && StApplication.isAtall.get(gid)) {
                ...
                } else if (mArray.get(position) && StApplication.isAtMe.get(gid) != null && StApplication.isAtMe.get(gid)) {
                    //有人@我 文字提示
                    ...
                    if (lastMsg.getTargetType() == ConversationType.group && !contentStr.equals("[群成员变动]")) {
                        ...
                        if (StApplication.isAtall.get(gid) != null && StApplication.isAtall.get(gid)) {
                            content.setText("[@所有人] " + fromName + ": " + contentStr);
                        } else if (StApplication.isAtMe.get(gid) != null && StApplication.isAtMe.get(gid)) {
