...
import com.stellaris.stchat.activity.SearchFriendDetailActivity;
...
import com.stellaris.stchat.view.SwipeLayout;
            ...
            public void gotResult(int i, String s, UserInfo userInfo) {
                if (i == 0) {
                    if (userInfo.isFriend()) {
                        ...
                        item.save();
                        FriendEntry entry = FriendEntry.getFriend(StApplication.getUserEntry(), item.username, item.appKey);
                        if (entry == null) {
        ...
        itemLl.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (entry.state.equals(FriendInvitation.INVITED.getValue())) {
                    ...
                    intent.putExtra(StApplication.TARGET_ID, entry.username);
                    intent.putExtra(StApplication.TARGET_APP_KEY, entry.appKey);
                    ...
                    JMessageClient.getUserInfo(item.username, new GetUserInfoCallback() {
                        ...
                        public void gotResult(int i, String s, UserInfo userInfo) {
                            if (i == 0) {
                                ...
                                intent1.putExtra(StApplication.TARGET_ID, entry.username);
                                intent1.putExtra(StApplication.TARGET_APP_KEY, entry.appKey);
