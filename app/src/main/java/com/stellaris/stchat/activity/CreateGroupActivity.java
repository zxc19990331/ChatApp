...
import com.stellaris.stchat.adapter.CreateGroupAdapter;
...
public class CreateGroupActivity extends BaseActivity implements View.OnClickListener, TextWatcher {
    ...
    private void initData() {
        UserEntry userEntry = StApplication.getUserEntry();
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.finish_btn:
                //拿到所选择的userName
                //Log.d("创建群组","#######" + StApplication.selectedUser.toString());
                if (StApplication.selectedUser != null && StApplication.selectedUser.size() > 0) {
                    StApplication.selectedUser.clear();
                }
                StApplication.selectedUser = mAdapter.getSelectedUser();
                Log.d("创建群组","#######" + StApplication.selectedUser.toString());
