...
//import com.stellaris.stchat.activity.SearchContactsActivity;
import com.stellaris.stchat.activity.fragment.ConversationListFragment;
import com.stellaris.stchat.adapter.ConversationListAdapter;
import com.stellaris.stchat.application.StApplication;
import com.stellaris.stchat.utils.DialogCreator;
import com.stellaris.stchat.utils.SortConvList;
import com.stellaris.stchat.utils.SortTopConvList;
...
public class ConversationListController implements View.OnClickListener,
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        if (position > 0) {
            ...
            intent.putExtra(StApplication.CONV_TITLE, conv.getTitle());
            //群聊
            if (conv.getType() == ConversationType.group) {
                ...
                intent.putExtra(StApplication.DRAFT, getAdapter().getDraft(conv.getId()));
                ...
                intent.putExtra(StApplication.TARGET_APP_KEY, conv.getTargetAppKey());
                intent.putExtra(StApplication.DRAFT, getAdapter().getDraft(conv.getId()));
            }
            intent.setClass(mContext.getActivity(), ChatActivity.class);
    ...
    public void delConversation() {
        mDatas.remove(StApplication.delConversation);
    }
}
