...
public class SharePreferenceManager {
    ...
    private static final String KEY_CACHED_USERNAME = "stchat_cached_username";
    ...
    private static final String KEY_CACHED_PSW = "stchat_cached_psw";
    ...
    private static final String KEY_CACHED_AVATAR_PATH = "stchat_cached_avatar_path";
    ...
    private static final String KEY_REGISTER_AVATAR_PATH = "stchat_register_avatar_path";
